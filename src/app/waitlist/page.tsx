            ...
            {isSubmitted ? (
              <div className="bg-green-50 border border-green-200 rounded-lg p-8 text-center">
                ...
                <p className="text-green-700 mb-6">
                  We'll notify you as soon as Cohort 2 opens. Keep an eye on your inbox!
                </p>
                <div className="border-t border-green-200 pt-6">
                  ...
                  <Button
                    onClick={() => window.open('https://discord.gg/pfKVnH3P', '_blank')}
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <Label htmlFor="linkedin" className="text-left block text-sm font-medium mb-2">
                      LinkedIn URL *
                    </Label>
                    <Input
                      id="linkedin" 
                ...
                >
                  ...
                  />
                  {isSubmitting ? 'Joining Waitlist...' : 'Join Cohort 2 Waitlist'}
                </Button>
